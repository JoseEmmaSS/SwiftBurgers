...
const mostarData = (data) => {
        ...
        <tr class="listaInventario border-b border-black duration-300 ease-in-out hover:bg-yellow-50 dark:border-neutral-500 dark:hover:bg-neutral-600">
          ...
          <td class="whitespace-nowrap dark:text-white text-lg px-6 py-4">
            <div class="flex space-x-4">
              <a class="inline-block bg-blue-500 hover:bg-blue-700 text-white text-lg font-bold py-2 px-4 rounded mr-2" id="editarInventario" onclick="editarInventario(${data[i].idPropietario})">
                <img class="h-4" src="../../../src/svg/editar.svg" alt="Editar">
              </a>
              <button onclick="eliminarPlatillo(${data[i].idPropietario})" id="eliminarFisicoInventario" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
  ...
  eliminarPlatillo = (idPropietario) => {
    Swal.fire({
