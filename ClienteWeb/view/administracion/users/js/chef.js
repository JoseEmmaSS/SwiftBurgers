  ...
  for (let i = 0; i < data.length; i++) {
    bodyInventario += `
        <tr class="listaInventario border-b border-black duration-300 ease-in-out hover:bg-yellow-50 dark:border-neutral-500 dark:hover:bg-neutral-600">
          ...
          <td class="whitespace-nowrap dark:text-white text-lg px-3 py-4">${data[i].nombre}</td>
          <td class="whitespace-nowrap dark:text-white text-lg px-3 py-4">${data[i].apellidoPaterno}</td>
          <td class="whitespace-nowrap dark:text-white text-lg px-3 py-4">${data[i].apellidoMaterno}</td>
          <td class="whitespace-nowrap dark:text-white text-lg px-3 py-4">${data[i].direccion}</td>
          <td class="whitespace-nowrap dark:text-white text-lg px-3 py-4">${data[i].numeroTelefono}</td>
          <td class="whitespace-nowrap dark:text-white text-lg px-3 py-4">${data[i].correo}</td>
          <td class="whitespace-nowrap dark:text-white text-lg px-3 py-4">${data[i].nombreUsuario}</td>
          <td class="whitespace-nowrap dark:text-white text-lg px-3 py-4">$ ${data[i].salario}</td>
          <td class="whitespace-nowrap dark:text-white text-lg px-3 py-4">
